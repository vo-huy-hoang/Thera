...
import { X, Send, Bot, User as UserIcon, Sparkles, Trash2 } from 'lucide-react-native';
...
export default function FloatingChatbot() {
  ...
  const translateX = useRef(new RNAnimated.Value(width - BUTTON_SIZE - EDGE_PADDING)).current;
  const translateY = useRef(new RNAnimated.Value(height - BUTTON_SIZE - 120)).current;
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Alert.alert('Lỗi', 'Không thể xóa lịch sử chat. Vui lòng thử lại.');
            }
          },
        },
      ]
