...
const OPTIONS = [
  { id: 'morning', label: 'Buổi sáng', icon: Sun, color: '#F59E0B', desc: 'Khởi đầu ngày mới sảng khoái' },
  { id: 'evening', label: 'Buổi tối', icon: Moon, color: '#4F46E5', desc: 'Thư giãn cơ thể trước khi ngủ' },
  { id: 'both', label: 'Cả 2', icon: Sparkles, color: '#10B981', desc: 'Tối ưu hiệu quả phục hồi' }
];
...
export default function ExerciseTimeScreen() {
  ...
  const requestNotificationPermission = async () => {
    ...
    if (finalStatus !== 'granted') {
      Alert.alert('Thông báo', 'Bạn hãy cho phép nhận thông báo để nhận lời nhắc luyện tập nhé!');
    }
  };
  ...
  const handleNext = async () => {
    ...
    router.replace({ pathname: '/(auth)/name', params: { ...params, exerciseTime: selectedId } });
  };
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.content}>
          ...
          >
            ...
            <Text style={styles.title}>Thời gian luyện tập?</Text>
            <Text style={styles.subtitle}>
              Chọn thời điểm thuận tiện nhất để TheraEase đồng hành cùng bạn.
            </Text>
          </MotiView>
            ...
            {OPTIONS.map((option, index) => {
              ...
              return (
                <MotiView
                  ...
                  style={[styles.optionWrapper, option.id === 'both' && styles.fullWidthOption]}
                >
                  <TouchableOpacity
                    style={[
                      styles.optionCard,
                      isSelected && { borderColor: option.color, shadowOpacity: 0.2, backgroundColor: '#FFFFFF' }
                    ]}
                    onPress={() => {
                      Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light);
                  ...
                  >
                    <View style={[
                      ...
                      <Icon size={20} color={isSelected ? '#FFFFFF' : '#6B7280'} strokeWidth={2.5} />
                    </View>
                ...
                <View style={styles.timeCard}>
                  ...
                  <View style={styles.recommendationBox}>
                    ...
                    <Text style={styles.recommendationText}>
                      Khuyên dùng: Luyện tập vào <Text style={{fontWeight: '700'}}>20:00 - 22:00</Text> giúp cơ thể phục hồi tốt nhất trước khi ngủ.
                    </Text>
                  </View>
                </View>
              </MotiView>
