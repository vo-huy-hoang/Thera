...
import { View, StyleSheet, Dimensions, TextInput, KeyboardAvoidingView, Platform } from 'react-native';
...
export default function AgeScreen() {
  ...
  const isValidAge = age.length > 0 && parseInt(age) >= 5 && parseInt(age) <= 110;
          ...
          <View style={styles.content}>
            ...
            >
              ...
              <Text style={styles.subtitle}>
                Hãy cho chúng tôi biết độ tuổi của bạn để cá nhân hóa cường độ tập luyện.
              </Text>
            </MotiView>
