...
const AREAS = [
	{
		...
		icon: Bone,
		color: "#5B9BD5",
		description: "Cải thiện vùng cổ vai gáy",
	},
	{
		id: "back",
		label: "Lưng & cột sống",
		...
		color: "#10B981",
		description: "Cải thiện đau vùng lưng, hông",
	},
	{
		id: "full",
		label: "Toàn thân",
		icon: Accessibility,
		color: "#8B5CF6",
		description: "Cải thiện cột sống cổ và lưng",
	},
];
				...
				<View style={styles.content}>
					...
					>
						<Button
							...
							style={[styles.button, !selectedArea && styles.buttonDisabled]}
