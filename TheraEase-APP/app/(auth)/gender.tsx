...
const OPTIONS = [
  { id: 'Nam', label: 'Nam', image: require('../../assets/gender-male.png'), color: '#3B82F6' },
  { id: 'Nữ', label: 'Nữ', image: require('../../assets/gender-female.png'), color: '#EC4899' }
];
          ...
          >
            ...
            <View style={styles.iconContainer}>
              <View style={styles.iconCircle}>
                <CircleUserRound size={32} color={colors.primary} strokeWidth={2.5} />
              </View>
            </View>
            
            <Text style={styles.title}>Giới tính của bạn?</Text>
            <Text style={styles.subtitle}>
              Thông tin này giúp chúng tôi tối ưu hóa các bài tập dựa trên đặc điểm thể trạng.
            </Text>
          </MotiView>
            ...
            {OPTIONS.map((option, index) => {
              ...
              return (
                <MotiView
                  ...
                  transition={{ delay: 200 * index, type: 'timing', duration: 500 }}
