      ...
      setReviews([
        {
          ...
          rating: 5,
          content: 'Điều tôi yêu thích nhất về ứng dụng là nó khiến bạn cảm thấy tuyệt vời về bản thân và 100% có thể tùy chỉnh với RẤT NHIỀU bài tập miễn phí, theo dõi bài tập, kế hoạch ăn uống, và hơn thế nữa!',
          badge: '-13kg'
        },
        {
          id: '2',
          ...
          rating: 5,
          content: 'Tôi từng bị đau lưng kinh niên do ngồi văn phòng quá lâu. Sau 2 tuần tập luyện theo lộ trình cá nhân hóa của TheraEase, cơn đau đã giảm đáng kể. Cảm ơn đội ngũ rất nhiều!',
          badge: 'Giảm 80% đau'
        },
        {
          id: '3',
          ...
          rating: 4,
          content: 'Ứng dụng rất dễ sử dụng, giao diện đẹp. Các bài tập được hướng dẫn chi tiết và phù hợp với sức khỏe của mình. Rất hài lòng với lộ trình hiện tại.',
          badge: 'Sống khỏe'
        }
      ]);
    } finally {
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        <Animated.View entering={FadeInUp.duration(600).springify()}>
          <Text style={styles.title}>Những câu chuyện thành{'\n'}công giúp bạn tạo thêm{'\n'}động lực</Text>
        </Animated.View>
