  ...
  return (
    <SafeAreaView style={styles.container} edges={[]}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={styles.contentContainer}>
        <Text style={styles.title}>Chính sách bảo mật TheraEase</Text>
        <Text style={styles.date}>Cập nhật lần cuối: {new Date().toLocaleDateString('vi-VN')}</Text>

        <Text style={styles.intro}>
          TheraEase cam kết bảo vệ quyền riêng tư và dữ liệu cá nhân của bạn. 
        ...
        <Text style={styles.paragraph}>
          ...
          • Tuổi{'\n'}
          • Nghề nghiệp{'\n'}
          • Email (nếu đăng nhập bằng Google)
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          • Gửi nhắc nhở trị liệu (nếu bạn cho phép){'\n'}
        ...
        <Text style={styles.paragraph}>
          ...
          • Với các nhà cung cấp dịch vụ đám mây để vận hành ứng dụng{'\n'}
          • Trong trường hợp khẩn cấp để bảo vệ sức khỏe và an toàn
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          • Lưu trữ dữ liệu trên hệ thống đám mây bảo mật cao{'\n'}
        ...
        <Text style={styles.paragraph}>
          • Dữ liệu được lưu trữ trên hệ thống đám mây bảo mật tại khu vực Châu Á{'\n'}
          • Chúng tôi lưu giữ dữ liệu của bạn miễn là tài khoản còn hoạt động{'\n'}
          • Sau khi xóa tài khoản, dữ liệu sẽ bị xóa vĩnh viễn trong vòng 30 ngày{'\n'}
          • Một số dữ liệu ẩn danh có thể được giữ lại cho mục đích phân tích
        </Text>
        ...
        <Text style={styles.paragraph}>
          Ứng dụng không dành cho người dưới 16 tuổi. Chúng tôi không cố ý thu thập 
          thông tin từ trẻ em. Nếu bạn là phụ huynh và phát hiện con bạn đã cung cấp 
          thông tin, vui lòng liên hệ để chúng tôi xóa dữ liệu.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          thông báo cho bạn về các thay đổi quan trọng qua email hoặc thông báo trong ứng dụng.
        </Text>
        ...
        <Text style={styles.footer}>
          Bằng việc sử dụng TheraEase, bạn xác nhận rằng bạn đã đọc và hiểu 
          Chính sách bảo mật này và đồng ý với việc thu thập và sử dụng thông tin 
          như được mô tả.
        </Text>
      </ScrollView>
    </SafeAreaView>
