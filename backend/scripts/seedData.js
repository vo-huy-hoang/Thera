...
async function seedData() {
  ...
  if (promptCount === 0) {
    await AiPrompt.insertMany([
      ...
      {
        prompt_type: 'chatbot',
        system_prompt: 'Bạn là trợ lý sức khỏe AI của TheraEase, chuyên về giảm đau cổ, vai, lưng. Hãy trả lời câu hỏi một cách chuyên nghiệp nhưng dễ hiểu. Luôn trả lời bằng tiếng Việt. Khuyến khích người dùng tập trị liệu đều đặn.',
        temperature: 0.7,
        max_tokens: 800,
        model: 'llama-3.3-70b-versatile',
        is_active: true,
